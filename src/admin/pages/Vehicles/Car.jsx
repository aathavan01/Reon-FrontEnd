...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><Link to="/VehiclesCar"><i class="bi bi-house-door"></i></Link></li>
          ...
          <tbody>
            <tr>
              ...
              <td class="d-flex align-items-center justify-content-between">
                <Link to="VehicleDetails"><button type="button" class="btn btn-success">Details <i class="bi bi-front"></i></button></Link>
